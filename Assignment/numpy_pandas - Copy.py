   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Array: [ 8 49 95 59  9 16 28 32 43 26]\n",
      "Mean: 36.5\n",
      "Median: 30.0\n",
      "Standard Deviation: 25.13662666309861\n"
     ]
    }
   ],
   "source": [
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Original Array: [ 2 14  2 65 16 98 56 19 35 35]\n",
      "Modified Array (odds replaced with -1): [ 2 14  2 -1 16 98 56 -1 -1 -1]\n"
     ]
    }
   ],
   "source": [
